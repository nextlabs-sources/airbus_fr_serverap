...
/**
 * Define the resource object and is a place holder for resource and all the attributes for the resource.
 * 
 * @author klee
 *
 */
public class ResourceObject {
	 ...
	 */
	public ResourceObject(String domain, String id, String type) {
		this.id = id;
		this.domain = domain;
	...
	/**
	 * Store the attributes list with IEvalValue object into the resource object
